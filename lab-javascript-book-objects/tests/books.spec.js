...
describe("Iteration 1 | Books Array", () => {
	describe("Array 'booksArray'", () => {
		it("should be an array", () => {
			expect(booksArrays).toBeDefined()
			expect(Array.isArray(booksArrays)).toBe(true)
		})

		it("should have 5 books", () => {
			expect(booksArrays.length).toEqual(5)
		})
	})

	describe("- Book Objects", () => {
		it('should have a string in property "title"', () => {
			for (let book of booksArrays) expect(typeof book.title).toBe("string")
		})

		it('should have a string in property "pages"', () => {
			for (let book of booksArrays) expect(typeof book.pages).toBe("number")
		})

		it('should have a string in property "author"', () => {
			for (let book of booksArrays) expect(typeof book.author).toBe("string")
		})

		it('should have an object in property "details"', () => {
			for (let book of booksArrays) expect(typeof book.details).toBe("object")
		})
	})
})
...
describe("Iteration 4 | Estimated Reading Time", () => {
	...
	describe("- Book Objects", () => {
		it("should have a property 'readingTime'", () => {
			for (let book of booksArrays) expect(book.readingTime).toBeDefined()
		})
